...
export const t = {
  ...
  upgradePromptDescription: 'Оформите подписку, чтобы читать статьи целиком и получить доступ ко всей базе знаний по гомеопатии',
  contactAdmin: 'Свяжитесь с администратором для оформления подписки',
  getSubscription: 'Связаться с администратором',
